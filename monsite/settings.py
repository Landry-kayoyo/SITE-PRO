...
# ⚙️ Configuration des fichiers médias
MEDIA_URL = "/media/"
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "Kayoyolandry@gmail.com"   # ton adresse Gmail
EMAIL_HOST_PASSWORD = "hduk exdh jich mtzh"  # mot de passe d’application
